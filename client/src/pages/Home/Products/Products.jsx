...
function Products() {
    return <section className="area_products">
        <div className="container normal_width">
            <h1>Produtos</h1>
            <p>Este é seu parágrafo de introdução da seção de produtos. 
            É o local ideal para apresentar os tipos de produtos disponíveis e destacar as
